...
(function(vue) {
  ...
  const k = true, I = "app", C = b([]), A = I, P = b('{\n    "address": [\n        "127.0.0.1",\n        "192.168.5.89",\n        "10.211.55.2",\n        "10.37.129.2"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = b('[{"provider":"aliyun","spaceName":"restaurant","spaceId":"mp-23363b05-a56c-4426-9e1d-8a903141c580","clientSecret":"/tFhBUdWnWnePk4rtByP7g==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "__UNI__F0F010D";
  } catch (e) {
...
详细信息：${s4}`), r3(i3);
  ...
  const _sfc_main$1 = {
    ...
    async onLoad() {
      try {
        ...
        formatAppLog("log", "at pages/index/index.vue:25", this.menus);
      } catch (e) {
        formatAppLog("log", "at pages/index/index.vue:27", { e });
      }
    },
    methods: {
      async addMenu() {
        try {
          ...
          formatAppLog("log", "at pages/index/index.vue:52", { res });
        } catch (e) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
      vue.createElementVNode("view", { class: "menus" }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($data.menus, (menu) => {
      ...
      vue.createElementVNode("button", {
        onClick: _cache[0] || (_cache[0] = (...args) => $options.addMenu && $options.addMenu(...args))
      }, "新增菜单")
    ]);
  }
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "/Users/caoyoujin/Documents/HBuilderProjects/restaurant/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/caoyoujin/Documents/HBuilderProjects/restaurant/App.vue"]]);
  function createApp() {
